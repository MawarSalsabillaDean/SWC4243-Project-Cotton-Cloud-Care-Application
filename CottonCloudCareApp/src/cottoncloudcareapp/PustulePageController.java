...
public class PustulePageController implements Initializable {
    ...
    @FXML
    private Label label_howForm_Pustule;

    @FXML
    private Label label_process_Pustule;

    @FXML
    private Text text_explanation_Pustule;

    @FXML
    private VBox vbox_factors;

    @FXML
    private ImageView image_factors_Pustule;

    @FXML
    private Label label_factors_Pustule;
    ...
    @FXML
    private ImageView image_prevention_Pustule;

    @FXML
    private Label label_prevention_Pustule;

    @FXML
    private Text text_prevention;

    @FXML
    private VBox vbox_prevention_Pustule;
