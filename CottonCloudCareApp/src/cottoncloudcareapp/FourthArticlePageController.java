...
public class FourthArticlePageController implements Initializable {
    
    @FXML
    private ImageView image_backbutton;

    @FXML
    private Label label_fourthArticle;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (webView != null) {
            String defaultUrl = "https://pureandcimple.com/blogs/our-blog/the-power-of-a-minimalist-approach-to-skincare";
