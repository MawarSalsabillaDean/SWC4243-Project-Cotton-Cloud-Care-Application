...
public class ThirdQuizQuestionController implements Initializable {
    ...
    @FXML
    private VBox vbox_question3;

    @FXML
    private Label label_2;

    @FXML
    private Label label_question3;

    @FXML
    private ImageView image_dryness;
    ...
    @FXML
    private Label label_titleDryness;
    ...
    private void handleYes() {
        ...
        showResult("Dry Skin Type");
    }

    @FXML
    private void handleNo() {
        // If No is for Normal Skin Type
        showResult("Normal Skin Type");
    }
