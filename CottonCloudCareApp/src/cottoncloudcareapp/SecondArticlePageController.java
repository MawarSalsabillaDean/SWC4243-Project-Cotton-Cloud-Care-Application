...
public class SecondArticlePageController implements Initializable {

    @FXML
    private ImageView image_backbutton;

    @FXML
    private Label label_firstArticle;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (webView != null) {
            String defaultUrl = "https://www.vogue.com/article/skincare-mechanical-vs-chemical-vs-physical-exfoliation"; 
